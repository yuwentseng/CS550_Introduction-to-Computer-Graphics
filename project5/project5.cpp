...
#include <GL/glu.h>
#include "glut.h" 
#include "glslprogram.h"  // include it after all GL stuff
...
const char* WINDOWTITLE = { "Project #5 -- YuWen Tseng" };
...
Display()
{
	...
	Pattern->SetUniformVariable("vertpattern", Vertexshader);
	Pattern->SetUniformVariable("fragpattern", Fragmentshader);
	glutSolidTeapot(1.);
	Pattern->Use(0);
...
InitGraphics()
{
	...
	bool valid = Pattern->Create("vertexS.vert", "fragmentS.frag");
